export default {
  ...
  'txt-task': 'Batch Import',
  'uri-task': 'URL',
  'torrent-task': 'Torrent',
  'txt-upload-tips': 'Drop TXT file here, or click to upload (one link per line)',
  'txt-task-preview': 'Link preview (editable)',
  'txt-link-count': '{{count}} links',
  'batch-import-title': 'Adding download tasks',
  'batch-import-progress': 'Added {{current}} / {{total}} tasks',
  'batch-import-batch': 'Processing batch {{current}} / {{total}}',
  ...
  'delete-all-task-confirm': 'Are you sure you want to remove all {{count}} download tasks?',
