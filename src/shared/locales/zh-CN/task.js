export default {
  ...
  'uri-task': '链接任务',
  'torrent-task': '种子任务',
  'txt-upload-tips': '将 TXT 文件拖到此处，或点击上传（每行一个链接）',
  'txt-task-preview': '链接预览（可编辑）',
  'txt-link-count': '共 {{count}} 个链接',
  'batch-import-title': '正在添加下载任务',
  'batch-import-progress': '已添加 {{current}} / {{total}} 个任务',
  'batch-import-batch': '正在处理第 {{current}} / {{total}} 批',
